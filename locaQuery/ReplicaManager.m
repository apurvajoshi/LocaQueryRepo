...
- (void)initialize
{
    ...
    CLLocation *locB = [[CLLocation alloc] initWithLatitude:+40.710992 longitude:-74.005615]; //New York
    CLLocation *locC = [[CLLocation alloc] initWithLatitude:+40.443390 longitude:-79.942332]; //UC
    ...
    [rep1 initialize:@"Replica1" :@"1" :@"http://scalepriv-idp.ece.cmu.edu:44447/api.php" :locA :true];
    //[rep1 initialize:@"Replica1" :@"1" :@"http://128.237.204.59:44447/api.php" :locA :true];

    
    Replica *rep2 = [[Replica alloc] init];
    [rep2 initialize:@"Replica2" :@"2" :@"http://scalepriv.ece.cmu.edu:44447/api.php" :locB :true];
...
/*
    ...
    [rep4 initialize:@"Replica4" :@"4" :@"http://scalepriv.ece.cmu.edu:44447/api.php" :locD :true];
*/    
